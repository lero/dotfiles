...
tags = {
  settings = {
    { names  = { "im", "web", "mail", "stuff", "t1", "t2" },
      layout = { layouts[2], layouts[1], layouts[1], layouts[2], layouts[1], layouts[1] }
    },
    { names  = { "stuff", "t1", "t2" },
...
--tags = {}
--for s = 1, screen.count() do
--    tags[s] = awful.tag({ "im", "web", "mail", "stuff", "t1", "t2" }, s, layouts[1])
--end
-- }}}
...
vicious.register(batwidget, vicious.widgets.bat, "bat $2% - $3", 60, "BAT0")

-- Volume widget
volwidget = widget({ type = "textbox" })
vicious.register(volwidget, vicious.widgets.volume, "vol $1% $2", 1, "Master")
...
globalkeys = awful.util.table.join(
    awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn_with_shell("amixer -q sset Master 2dB-") end),
    awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn_with_shell("amixer -q sset Master 2dB+") end),
